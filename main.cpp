...
Class: CIS227-6800
Assignment 2: Portable .h and .cpp Files
...
int main(int intArgumentCount, char *charArgumentVector[])
{
	...
	CheckForCommandLineParameters(intArgumentCount, charArgumentVector);
	...
	do
	{
		...
		cout << "\nRun again? (y/n) ";
		cin >> strResponse;
		if (strResponse == "y" || strResponse == "yes")
			bRunAgain = true;
